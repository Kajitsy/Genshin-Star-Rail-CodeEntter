...
browser.storage.local.get(['onlyHsr', 'onlyGi', 'onlyZzz']).then(function (result) {
  ...
  if (result.onlyHsr) {
    ...
    browser.storage.local.get(['buttonColorZzz', 'buttonTextColorZzz', 'BackgroundZzz', 'BackgroundColorZzz']).then((result) => {
